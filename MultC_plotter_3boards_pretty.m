...
fname1 = sprintf('rack_test_20140602_145027');% 
fname2 = sprintf('rack_CN_simple_S1M1_20140602_145029');
fname3 = sprintf('rack_emg_20140602_145030');
...
subplot (n,1, 2);
hLine2 = line(t(start:last), total_spike_count_sync(start:last));
set(hLine2                        , ...
  'LineStyle'       , '-'         , ...
  'LineWidth'       , 3           , ...   
  'Color'           , 'black'  );
...
%% velocity
subplot (n,1, 4);
hLine4 = line(t(start:last), total_force_out_muscle0_sync(start:last));
set(hLine4                        , ...
  'LineStyle'       , '-'         , ...
  'LineWidth'       , 3           , ...   
  'Color'           , 'black'  );
